<template>
	<view-box v-ref:view-box class="errorList">
				...
				<div class="weui_panel_bd"> 
					...
					<div class="weui_media_bd weui_media_box "> 
						<p class="weui_media_desc">
							<img v-bind:src="item.src" height="200" class="previewer-demo-img" @click="$refs.previewer.show($index)"/>
						</p>
					</div> 
				</div>
			</div>
		...
		<previewer :list="list.list" v-ref:previewer :options="options"></previewer>
...
export default {
	components: {
		XHeader,Flexbox,FlexboxItem,ViewBox,Group,Previewer 
	},
	methods: {
		_remove(){
			 this.show = true
