<template>
  <view-box body-padding-top="46px">
    ...
    <div>
      <group-title style="margin:10px 0 0;">需要上传作业后方可查看答案,最多4张</group-title>
      <div style="padding:10px 15px">
        <flexbox wrap="wrap" align="baseline" :gutter="0">
          <flexbox-item :span="3" v-for="(img, index) in workbookWant.list" :key="index">
            <div class="photo">
          ...
          <flexbox-item :span="3" v-if="!(workbookWant.list.length === 4)" @click.native="_add">
            <div class="photo">
              <div class="plus">
                <b>+</b>
              </div>
