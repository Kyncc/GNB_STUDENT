<template>
  <view-box ref="about" body-padding-top="46px">
    ...
    <div>
      <group :gutter='0' title='只展示最近一个月的试卷' v-show='DownloadRemember.list.length'>
        <cell :title='item.name' v-for='(item, index) in DownloadRemember.list' :key='index'>
      ...
      <div style="text-align:center;padding:10px 0;">
        ...
        <p v-else-if="!DownloadRemember.list.length" style="font-size:16px;color:#4cc0be">近一月还未有下载记录</p>
