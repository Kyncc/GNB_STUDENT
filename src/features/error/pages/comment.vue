<template>
  <view-box ref="viewBox" body-padding-top="46px">
    ...
    <div>
      <card :header="{title: item.name}" v-for='(item, index) in errorComment' :key='index'>
        <div slot="content">
          <div>
            <flexbox>
...
export default {
  ...
  methods: {
    ...mapActions(['getErrorComment', 'setErrorCommentClear']),
    // 播放上次声音
    _audio (url, index) {
